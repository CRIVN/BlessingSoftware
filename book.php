        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-10 col-sm-12 ftco-animate text-center"  style="padding-bottom: 25%;">
              <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Inicio</a></span> <span>Reservar</span></p>
              <h1 class="mb-3">Reservar</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row block-9 mb-4">
	        <div class="col-md-6 pr-md-5 flex-column">
	            <div class="row d-block flex-row">
	              <h2 class="h4 mb-4">Informacion de contacto</h2>
		            <div class="col mb-3 d-flex py-4 border" style="background: white;">
		                <div class="align-self-center">
		                	<p class="mb-0"><span>Nombre:</span> <a href=""><?php echo $reservation_name; ?></a></p>
		                	<p class="mb-0"><span>Telefono:</span> <a href="tel://1234567920"><?php echo $reservation_phone; ?></a></p>
			                <p class="mb-0"><span>Fecha de reservacion:</span> <a href=""><?php echo $reservation_date; ?></a></p>
			                <p class="mb-0"><span>Hora de reservacion:</span> <a href=""><?php echo $reservation_time; ?></a></p>
		                </div>
		            </div>
	              	<div class="col mb-3 d-flex py-4 border" style="background: white;">
		                <div class="align-self-center">
	                      <p class="mb-0"><span>Mesa num:</span>
          	...
          	<div class="col-md-6 pr-md-5 flex-column">
	            <div class="row d-block flex-row">
	              <h2 class="h4 mb-4">Informacion del menu de items</h2>
		            <div class="col mb-3 d-flex py-4 border" style="background: white;">
	              	...
	              	<div class="col mb-3 d-flex py-4 border" style="background: white;">
		                <div class="align-self-center">
		                  	<p class="mb-0"><span>Precio total:</span> <a href=""><?php echo $total_price; ?> ₹</a></p>
		                </div>
	              	</div>
	        	</div>
          	</div>
