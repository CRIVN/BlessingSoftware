					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Paginas</span></li>
								<li><span>Factura</span></li>
							</ol>
							...
							<div class="invoice">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="bill-to">
												...
												<address>
													...
													<br/>
													Telefono +52 <?php echo $booking_phone; ?>
										...
										<div class="col-md-6">
											<div class="bill-data text-right">
												<p class="mb-none">
													<span class="text-dark">Fecha de reservacion:</span>
													<span class="value"><?php echo $booking_date; ?></span>
												</p>
												<p class="mb-none">
													<span class="text-dark">Hora de reserva:</span>
								...
								<div class="bill-info">
									<div class="row">
										<div class="col-md-6">
											<div class="bill-to">
												<p class="h5 mb-xs text-dark text-semibold">Mesa y silla:</p>
												<address>
													<?php 
													$booking_number = $_GET['booking-number'];
									...
									<table class="table invoice-items">
										<thead>
											<tr class="h4 text-dark">
												...
												<th id="cell-item"   class="text-semibold">Nombre de item</th>
												<th id="cell-price"  class="text-left text-semibold">Precio</th>
