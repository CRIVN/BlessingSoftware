					...
					<div class="panel-body">
						<form action="" method="POST">
							...
							<div class="mb-xs text-center">
								<a class="btn btn-facebook mb-md ml-xs mr-xs">Inicia con <i class="fa fa-facebook"></i></a>
								<a class="btn btn-twitter mb-md ml-xs mr-xs">Inicia con <i class="fa fa-twitter"></i></a>
							</div>

							<!-- <p class="text-center">¿Aun no tienes una cuenta? <a href="pages-signup.html">Registrate!</a> -->
...
// echo $ecnpassword;
	...
	if ($emailResult->num_rows <= 0) {
		echo '<script>alert("Este Email no existe.")</script>';
