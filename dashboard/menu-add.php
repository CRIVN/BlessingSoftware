					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Opcion del menu</span></li>
							...
							<form action="manage-insert.php" method="POST" enctype="multipart/form-data">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Opcion del menu</h2>

										<p class="panel-subtitle">
											Para anadir <code>Opcion del menu</code> Por favor llene todos los campos
										</p>
									</header>
