        ...
        <section role="main" class="content-body">
          ...
          <section>
                ...
                if (isset($_POST['save'])) {
                  ...
                  if ($cur) {
                    # code...
                    echo '<script>alert("Las cuentas han sido actualizadas.")</script>';
                    ...
                    if ($extension =="jpg" || $extension =="png" || $extension =="jpeg"){
                      move_uploaded_file($file_tmp,$targetDirectory.$file_name);
                        ...
                        if ($con->query($sql) === TRUE) {
                          echo '<script>alert("El logotipo ha sido actualizado")</script>';
                          echo '<script>window.location="profile.php"</script>';
                        }else {
      ...
      <div class="row">    
              ...
              <div class="form-group">
                ...
                <label class="col-md-4 control-label" for=
                  "Fname">Nombre del restaurante:</label>

                  <div class="col-md-8">
                   <input type="text" name="fullname" class="form-control" required="" placeholder="Nombre del restaurante" value="<?php echo $row['restaurent_name'];?>">
                  </div>
                </div>
              </div> 
              ...
              <div class="form-group">
                <div class="col-md-7">
                <label class="col-md-4 control-label" for=
                  "Lname">Direccion:</label>

                  <div class="col-md-8"> 
                     <input type="email" name="email" class="form-control" required="" placeholder="Email del restaurante" value="<?php echo $row['email'];?>">
                  </div>
                </div>
              </div> 
              ...
              <div class="form-group">
                <div class="col-md-7">
                <label class="col-md-4 control-label" for=
                  "Mname">Numero de telefono:</label>

                  <div class="col-md-8"> 
                     <input type="text" name="phone" class="form-control" required="" placeholder="Telefono del restaurante" value="<?php echo $row['phone'];?>">
                  </div>
                </div>
              </div> 
              <div class="form-group">
                <div class="col-md-7">
                  <label class="col-md-4 control-label" for=
                  "CustomerAddress">Locacion:</label>

                  <div class="col-md-8">
                     <select class="form-control " name="area" required="">
                            <option value=""> -Seleccione el area del restaurante- </option>
                            <?php   
              ...
              <div class="form-group">
                <div class="col-md-7">
                  <label class="col-md-4 control-label" for=
                  "Gender">Direccion:</label>

                  <div class="col-md-8"> 

                     <textarea name="address" id="" cols="30" rows="2" class="form-control" placeholder="Direccion del restaurante"><?php echo $row['address'];?></textarea>
                  </div>
                </div>
              </div> 
               ...
               <div class="form-group">
                <div class="col-md-7">
                  <label class="col-md-4 control-label" for=
                  "CustomerContact">Contrasena:</label>

                  <div class="col-md-8">
                     <input type="password" name="password" class="form-control" required="" placeholder="Contrasena" value="<?php echo $row['password'];?>">
                  </div>
                </div>
              </div>   
                            ...
                            <div class="modal-content">
                                ...
                                "post">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        name="savephoto" type="submit">Cargar imagen</button>
                                    </div>
                                </form>
                            </div><!-- /.modal-content-->
                        </div><!-- /.modal-dialog -->
