			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Mesas de restaurante</span></li>
								<li><span>Lista de sillas</span></li>
							</ol>
					...
					<!-- start: page -->
						...
						<section class="panel">
							<a href="#exampleModal" class="btn btn-success"  data-toggle="modal" >Anadir</a>
							<header class="panel-heading">
								<div class="panel-actions">
									<a href="#" class="fa fa-caret-down"></a>
									<a href="#" class="fa fa-times"></a>
								</div>
								<h2 class="panel-title">Todas las sillas</h2>
							</header>
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td class="center hidden-phone">
												<a href="delete-chair.php?chair_id=<?php echo $r['id'];?>&tbl_id=<?php echo $tbl_id;?>" class="btn btn-danger"  onclick="if (!Done()) return false; ">Eliminar silla</a>
											</td>
										</tr>
										<?php $count++; } ?>
									</tbody>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="exampleModalLabel">Anadir silla</h5>
