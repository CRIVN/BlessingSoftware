...
if (!isset($_SESSION['isLoggedIn'])) {
    echo '<script>alert("Necesita iniciar sesion primero")</script>';
        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-10 col-sm-12 ftco-animate text-center"  >
              <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Inicio</a></span> <span>Reservacion</span></p>
              <h1 class="mb-3">Crear reservacion</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 reservation pt-5 px-5">
              <p style="font-size: 20px; color: #000;font-weight: bold;margin-top: -30px">Crear reservacion</p>
      ...
      <div class="container">
        <div class="row no-gutters justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2>Seleccione la fecha y hora de la reservacion</h2>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="reservation_name" class="form-control" placeholder="Nombre" required="" value="<?php echo $_SESSION['name'];?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Telefono</label>
                    <input type="text" name="reservation_phone" class="form-control" placeholder="Telefono" required="" value="<?php echo $_SESSION['phone'];?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Fecha</label>
                    <input type="date" name="reservation_date" class="form-control" placeholder="Fecha" required="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Hora</label>
                    <select name="reservation_time" class="form-control" placeholder="Hora" required="">
