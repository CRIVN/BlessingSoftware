        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-10 col-sm-12 ftco-animate text-center"  style="padding-bottom: 25%;">
              ...
              <h1 class="mb-3">Nuestro exclusivo menu</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="col-md-8 dish-menu">
            ...
            <div class="nav nav-pills justify-content-center ftco-animate" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              <a class="nav-link py-3 px-4 active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><span class="flaticon-meat"></span> Comida rapida</a>
          ...
          <div class="col-md-4">
        		<h2 class="h4 mb-4">Informacion de reserva</h2>
                ...
                <div class="row d-block flex-row">
                  ...
                  <div class="col mb-2 d-flex py-4 border" style="background: white;">
                    <div class="align-self-center">
                      ...
                      <p class="mb-0"><span>Silla num:</span>
